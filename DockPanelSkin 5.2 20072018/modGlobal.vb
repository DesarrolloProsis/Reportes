...
Module modGlobal
    ...
    Public BanderaCierre As Boolean = False
    ...
    Public banValidaciones As Boolean = True
    ...
    Public str_encargado_turno As String
    ...
    Public gl_str__automatica As String
